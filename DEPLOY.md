...
## Configuração para subdiretório `/rai/2025/`

O projeto está configurado para rodar em `https://stagebrb.regiusprev.com.br/rai/2025/`
...
2. **Upload dos arquivos:**
   ...
   - Certifique-se de que o arquivo `.htaccess` está presente na raiz do diretório `/rai/2025/`
...
3. **Configuração do servidor (Apache):**
   ...
   <IfModule mod_rewrite.c>
     RewriteEngine On
     RewriteBase /rai/2025/
     RewriteRule ^index\.html$ - [L]
     RewriteCond %{REQUEST_FILENAME} !-f
     RewriteCond %{REQUEST_FILENAME} !-d
     RewriteRule . /rai/2025/index.html [L]
   </IfModule>
   ```
...
- `https://stagebrb.regiusprev.com.br/rai/2025/` - deve carregar a página inicial
- `https://stagebrb.regiusprev.com.br/rai/2025/governanca` - deve carregar a página de governança
...
- Certifique-se de que o `RewriteBase` está correto (`/rai/2025/`)

**Assets não carregam (CSS, JS, imagens):**
- Verifique se o `base: '/rai/2025/'` está configurado no `vite.config.js`
