          ...
          <div className="pop-bottom-grid dstq-reveal dstq-reveal--d2">
            <div className="pop-card">
              ...
              <div className="pop-gender-bar">
                <div className="pop-gender-masc" style={{ flex: '66' }}>
                  <span>♂ Masculino</span>
                  <strong>66%</strong>
                </div>
                <div className="pop-gender-fem" style={{ flex: '34' }}>
                  <strong>34%</strong>
                  <span>Feminino ♀</span>
                </div>
              </div>
              <div className="pop-gender-legend">
                <span><i className="pop-dot pop-dot--masc" />Masculino — 66%</span>
                <span><i className="pop-dot pop-dot--fem" />Feminino — 34%</span>
              </div>
            </div>
    ...
    <section id="investimentos" className="plano-section plano-section--light">
      <div className="container">
        ...
        <div className="dstq-cta-wrap" style={{ marginTop: 40 }}>
          <a
            href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/demonstracao-atuarial-2025-plano-cd-02.pdf"
            target="_blank"
...
function SecaoArrecadacao() {
  const fluxData = {
    ...
    datasets: [
      { label: "Arrecadação", data: [3494263, 2939098, 2435607], backgroundColor: "#00aeef", borderRadius: 4 },
      { label: "Benefícios/Institutos", data: [15638144, 10939525, 9155841], backgroundColor: "#0074c8", borderRadius: 4 },
    ],
  };
  ...
  const fluxOptions = {
    ...
    scales: {
      y: {
        ticks: { callback: fmtAxis, color: DARK_CHART_OPTS.color },
        grid: { color: DARK_CHART_OPTS.borderColor },
      },
      ...
      onComplete: function () {
        ...
        chart.data.datasets.forEach((dataset, di) => {
          ...
          meta.data.forEach((bar, i) => {
            ...
            if (val > 0) ctx.fillText(fmtLabel(val), bar.x, bar.y - 4);
          });
        });
      },
    },
  ...
  return (
    <section id="atuarial" className="plano-section plano-section--light">
      <div className="container">
        ...
        <div className="dstq-cta-wrap" style={{ marginTop: 40 }}>
          <a
            href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/parecer-atuarial-exercicio-2025-cd-02-previdencia-brb.pdf"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <table className="plano-table">
            ...
            <tbody>
              ...
              <tr className="total">
                ...
                <td className="num"><strong>152.482</strong></td>
                <td className="num"><strong>191.337</strong></td>
                <td className="num"><strong>343.820</strong></td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <table className="plano-table">
              ...
              <tbody>
                ...
                <tr className="total">
                  ...
                  <td className="num"><strong>52.132</strong></td>
                </tr>
                <tr className="total" style={{ background: 'rgba(0,174,239,0.12)' }}>
                  <td><strong>TOTAL</strong></td>
                  <td className="num"><strong>4.213.747</strong></td>
                </tr>
              </tbody>
            </table>
          </div>
