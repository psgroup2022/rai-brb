                    ...
                    <div className="pop-hero">
                        <div>
                            ...
                            <div className="pop-total-delta">
                                <span className="pop-delta-badge" style={{ color: '#16a34a', background: 'rgba(22, 163, 74, 0.1)' }}>▲ 14,85%</span>
                    ...
                    <div className="pop-bottom-grid dstq-reveal dstq-reveal--d2">
                        <div className="pop-card">
                            ...
                            <div className="pop-gender-bar">
                                <div className="pop-gender-masc" style={{ width: '46%' }}>
                                    <span>♂ Masculino</span>
                                    <strong>46%</strong>
                                </div>
                                <div className="pop-gender-fem" style={{ width: '54%' }}>
                                    <strong>54%</strong>
                                    <span>Feminino ♀</span>
                                </div>
                            </div>
                            <div className="pop-gender-legend">
                                <span><i className="pop-dot pop-dot--masc" />Masculino — 46%</span>
                                <span><i className="pop-dot pop-dot--fem" />Feminino — 54%</span>
                            </div>
                        </div>
        ...
        <section id="atuarial" className="plano-section plano-section--light">
            <div className="container">
                ...
                >
                    ...
                    <div style={{ flex: 1 }}>
                        <p style={{ margin: 0, color: '#0a1f3c', fontSize: '1.05rem', lineHeight: '1.5', fontWeight: '500' }}>
                        <a href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/parecer-atuarial-exercicio-2025-brasiliaprev-previdencia.pdf" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
