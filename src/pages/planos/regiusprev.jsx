          ...
          <div className="pop-hero">
            <div>
              ...
              <div className="pop-total-delta">
                      <span className="pop-delta-badge" style={{ color: '#16a34a', background: 'rgba(22, 163, 74, 0.1)' }}>
                        ▲ 10,17%
                      </span>
    ...
    <section id="investimentos" className="plano-section plano-section--light">
      <div className="container">
        ...
        <div className="dstq-cta-wrap" style={{ marginTop: 24 }}>
          <a
            href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/demonstracao-atuarial-2025-plano-regiusprev.pdf"
            target="_blank"
