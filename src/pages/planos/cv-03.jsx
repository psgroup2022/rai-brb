                    ...
                    <div className="pop-bottom-grid dstq-reveal dstq-reveal--d2">
                        <div className="pop-card">
                            ...
                            <div className="pop-gender-bar">
                                <div className="pop-gender-masc" style={{ width: '55%' }}>
                                    <span>♂ Masculino</span>
                                    <strong>55%</strong>
                                </div>
                                <div className="pop-gender-fem" style={{ width: '45%' }}>
                                    <strong>45%</strong>
                                    <span>Feminino ♀</span>
                                </div>
                            </div>
                            <div className="pop-gender-legend">
                                <span><i className="pop-dot pop-dot--masc" />Masculino — 55%</span>
                                <span><i className="pop-dot pop-dot--fem" />Feminino — 45%</span>
                            </div>
                        </div>
        ...
        <section id="investimentos" className="plano-section plano-section--light">
            <div className="container">
                ...
                <div className="dstq-cta-wrap" style={{ marginTop: 40 }}>
                    <a
                        href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/demonstracao-atuarial-2025-plano-cv-03.pdf"
                        target="_blank"
    ...
    return (
        <section id="atuarial" className="plano-section plano-section--light">
            <div className="container">
                ...
                <div className="dstq-cta-wrap" style={{ marginTop: 40 }}>
                    <a
                        href="https://previdenciabrb.org.br/wp-content/uploads/2026/04/parecer-atuarial-exercicio-2025-cv-03-previdencia-brb.pdf"
                        target="_blank"
                        rel="noopener noreferrer"
...
function PlanoCV03() {
    ...
    return (
        <>
            ...
            <SecaoIndicePlanos particlesId="services-particles-cv03" />
