...
function MensagemLiderancas() {
    const resumoCards = [
        ...
        },
        {
            value: '53',
            ordinal: 'ª',
            label: 'No ranking de 223 EFPC da ABRAPP',
        },
        {
            value: '0,42%',
